...
def test_candidate_path_is_stable_and_not_a_vulnerability_verdict() -> None:
    ...
    first = build_candidate_path(project_id="P001", input_candidate=input_candidate, effect_candidate=effect_candidate, intermediate_nodes=[middle], edges=edges, path_status="COMPLETE_STATIC", detector_commit="commit-1")
    second = build_candidate_path(project_id="P001", input_candidate=input_candidate, effect_candidate=effect_candidate, intermediate_nodes=[middle], edges=edges, path_status="COMPLETE_STATIC", detector_commit="commit-1")
    assert first == second
